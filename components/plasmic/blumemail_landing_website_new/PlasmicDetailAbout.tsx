...
import sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: nAsFMT_b1Eiv/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__j0SiA)}>
            <PlasmicImg__
          ...
          <div className={classNames(projectcss.all, sty.column__bqtAo)}>
            <h5
