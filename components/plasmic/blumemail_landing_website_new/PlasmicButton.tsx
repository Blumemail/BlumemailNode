...
import sty from "./PlasmicButton.module.css"; // plasmic-import: IKalveoma9Lb/css
    ...
    >
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg___7By8U)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__iszfD)}
                role={"img"}
              />
            ),
