  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__ncFfn)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__ayOg0)}>
          <PriceCard
            borders={["flatLeft"]}
            className={classNames("__wab_instance", sty.priceCard__pPnvs)}
          />
        </div>
