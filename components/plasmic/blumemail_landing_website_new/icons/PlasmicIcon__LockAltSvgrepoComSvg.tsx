...
export type LockAltSvgrepoComSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function LockAltSvgrepoComSvgIcon(props: LockAltSvgrepoComSvgIconProps) {
...
export default LockAltSvgrepoComSvgIcon;
/* prettier-ignore-end */
