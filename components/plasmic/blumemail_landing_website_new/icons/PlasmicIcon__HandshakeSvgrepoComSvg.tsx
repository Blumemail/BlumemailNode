...
export type HandshakeSvgrepoComSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function HandshakeSvgrepoComSvgIcon(
  props: HandshakeSvgrepoComSvgIconProps
) {
...
export default HandshakeSvgrepoComSvgIcon;
/* prettier-ignore-end */
