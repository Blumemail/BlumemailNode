...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: NOrjTyDBFUg5/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__bify9)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__sNf)}
              role={"img"}
            />
          ),
