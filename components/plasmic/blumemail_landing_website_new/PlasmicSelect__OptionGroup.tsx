...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: WEb60MSSF2m4/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: h50HF9iyKgoV/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__c2TzO)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__s7VoB)}
              />
            </React.Fragment>
          ),
          value: args.children
